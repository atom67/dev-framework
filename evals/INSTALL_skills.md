...
1. `git clone --depth 1 https://github.com/trenthalden/dev-framework {{WORK}}/dev-framework`
2. Install its two skills into this Hermes profile, then confirm they are listed:
   `hermes skills install trenthalden/dev-framework/skills/import-dev-framework --yes`
   `hermes skills install trenthalden/dev-framework/skills/catch-up --yes`
   `hermes skills list`
