...
of error. `init` recommends from the kind and scale; the operator decides. This repository itself runs lean:
11 scenario tests, gate under 30 seconds.
...
**v1.5.0 (beta; Hermes + Claude Code).** On Hermes, the plugin runs of three scenarios used 0.33–0.55× the tool calls and
...
remote services or commits. Eleven scenario tests cover install/update/backup, the gates, the
brief and hook, host rules and the devlog.
